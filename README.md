...
3. [SpaceXAI 的 Grok 编程工具正在将用户的整个代码库上传到云存储](https://aihot.bt199.com/news/9dc0222d45c1/)
   - SpaceXAI 的 Grok Build AI 编码工具被发现在报道之前将用户的整个代码库上传到谷歌云，该公司将其关闭…
   - `The Verge AI · 2026-07-14`

4. [Meta 被指控使用有偏见的人工智能定位进行大规模裁员](https://aihot.bt199.com/news/729bc486f471/)
