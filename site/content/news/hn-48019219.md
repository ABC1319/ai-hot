...
description = "Google Chrome 在未经同意的情况下在您的设备上静默安装 4 GB AI 模型"
seo_title = "Google Chrome 在未经同意的情况下在您的设备上静默安装 4 GB AI 模型｜AI资讯解读 - AI热榜"
seo_description = "Google Chrome 在未经同意的情况下在您的设备上静默安装 4 GB AI 模型"
seo_keywords = "Google Chrome 在未经同意的情况下在您的设备上静默安装 4 GB AI 模型, Hacker News, AI新闻, AI资讯, AI热榜"
slug = "hn-48019219"
type = "news"
...
lang = "en"
intro = "Google Chrome 在未经同意的情况下在您的设备上静默安装 4 GB AI 模型"
ai_summary = "Google Chrome 在未经同意的情况下在您的设备上静默安装 4 GB AI 模型"
summary = "Google Chrome silently installs a 4 GB AI model on your device without consent"
summary_zh = "Google Chrome 在未经同意的情况下在您的设备上静默安装 4 GB AI 模型"
tags = []
list_page = 11
+++
